...
@Component({
  selector: 'product-slide-mobile',
  templateUrl: './product-slide-mobile.component.html',
  styleUrls: ['./product-slide-mobile.component.scss']
})
export class ProductSlideMobileComponent implements OnInit {
